...
public class VesselSinkingController {
    ...
    public void getVesselSank(String typeOfShip, int numberOfContainers) throws IOException {
        ...
        data.append("Container Mass: " + String.format("%.2f",vesselSinking.getContainerMass()) + "kg\n" +
                "Sea water density considered: " + String.format("%.2f",vesselSinking.getSeaWaterDensity()) + "g/m3\n" +
                ...
                "Height before sinking: " + String.format("%.5f",vesselSinking.getVesselHeight()) + "m\n" +
                "Height After sinking: " + String.format("%.5f",vesselSinking.getDraft()) + "m\n" +
                "Difference in height that the vessel has suffered: " + String.format("%.5f",vesselSinking.getVesselSinking()) + "m\n");
